...
import (
	...
	hellosvcsvr "github.com/pvr1/goatest/gen/grpc/hellosvc/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, hellosvcEndpoints *hellosvc.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		hellosvcServer = hellosvcsvr.New(hellosvcEndpoints, nil)
	}
	...
	hellosvcpb.RegisterHellosvcServer(srv, hellosvcServer)
